...
# Load the package
library(Ohdsi2020StudyathonCohortDiagnosticsRcri)
package <- "Ohdsi2020StudyathonCohortDiagnosticsRcri"
path <- "s:/results"
...
Ohdsi2020StudyathonCohortDiagnosticsRcri::runCohortDiagnostics(connectionDetails = connectionDetails,
