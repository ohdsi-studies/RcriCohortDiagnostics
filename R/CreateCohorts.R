...
#
# This file is part of Ohdsi2020StudyathonCohortDiagnosticsRCRI
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "Ohdsi2020StudyathonCohortDiagnosticsRCRI")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "Ohdsi2020StudyathonCohortDiagnosticsRCRI")
