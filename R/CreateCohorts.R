...
#
# This file is part of RcriCohortDiagnostics
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "RcriCohortDiagnostics")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "RcriCohortDiagnostics")
